...
final class TenantAccessController extends Controller implements TenantAccessInterface
{
    ...
    public function Register(Request $request): JsonResponse
    {
        ...
        try {
            ...
            $status = [
                ...
                'unique_tenant_id' => $verify_token_was_sent,
            ];
        } catch (\Exception $ex) {
    ...
    public function LoginDashboard(Request $request): JsonResponse
    {
        ...
        try {
            ...
            $status = [
                ...
                'uniqueTenantId' => $foundDetail['unique_tenant_id'], //for Tenant Authentication
                'authTenantToken' => $auth_header_token_text, //for Authorization header using Sanctum...
    ...
    public function ConfirmLoginState(Request $request): JsonResponse
    {
        ...
        try {
            $confirm_login_state = $this?->TenantConfirmLoginStateService($request);
    ...
    public function VerifyAccount(Request $request): JsonResponse
    {
        try {
            ...
            if (!$confirm_verify_state) 
            {
                ...
                {
                    throw new \Exception("Tenant Email was not verified! Try Again!");
                }
