...
const EDIT_PROFILE_DETAIL_API_URL: URL = new URL( (process.env.LANDLORD_BASE_API_URL  as string) + 'utils/dashboard/profile/edit/profile/details');
const EDIT_PROFILE_IMAGE_API_URL: URL = new URL( (process.env.LANDLORD_BASE_API_URL  as string) + 'utils/dashboard/profile/edit/profile/image');
