//use the fetch API:
const SEND_TOKEN_MAIL_API_URL: URL = new URL( (process.env.TENANT_BASE_API_URL  as string) + 'guest/send/reset/password/token');
const IMPLEMENT_PASS_RESET_URL: URL = new URL( (process.env.TENANT_BASE_API_URL  as string) + 'guest/reset/password');
